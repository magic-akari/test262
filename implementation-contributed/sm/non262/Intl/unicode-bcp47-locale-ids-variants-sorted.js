...
assert.sameValue(Intl.getCanonicalLocales("en-scouse-fonipa")[0], "en-fonipa-scouse");
...
assert.sameValue(Intl.getCanonicalLocales("sl-rozaj-biske-1994")[0], "sl-1994-biske-rozaj");
