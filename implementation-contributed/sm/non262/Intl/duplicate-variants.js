...
assert.compareArray(Intl.getCanonicalLocales("de-1996"), ["de-1996"]);
assertThrowsInstanceOf(() => Intl.getCanonicalLocales("de-1996-1996"), RangeError);

// Multiple different variants are allowed.
assert.compareArray(Intl.getCanonicalLocales("sl-rozaj-solba"), ["sl-rozaj-solba"]);

// Variants can have the same prefix.
assert.compareArray(Intl.getCanonicalLocales("zh-Latn-pinyin-pinyin2"), ["zh-Latn-pinyin-pinyin2"]);

// Values in extension sequences are not counted as variants.
assert.compareArray(Intl.getCanonicalLocales("en-u-kf-false-kn-false"), ["en-u-kf-false-kn-false"]);
...
assert.compareArray(Intl.getCanonicalLocales("en-u-kn-false-kn-false"), ["en-u-kn-false"]);
assert.compareArray(Intl.getCanonicalLocales("en-u-attr1-attr2-attr2"), ["en-u-attr1-attr2"]);
