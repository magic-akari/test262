...
gc();
let marks = getMarks();
assert.sameValue(marks[0], 'gray', 'gray root');
assert.sameValue(marks[1], 'gray', 'object reachable from gray root');
assert.sameValue(marks[2], 'black', 'global');
assert.sameValue(marks[3], 'dead', 'dead object should have been collected');

grayRoot().x = 7; // Overwrite the object
gc();
marks = getMarks();
assert.sameValue(marks[0], 'gray', 'gray root');
assert.sameValue(marks[1], 'dead', 'object no longer reachable from gray root');
assert.sameValue(marks[2], 'black', 'global');
assert.sameValue(marks[3], 'dead', 'dead object should have been collected');
...
gc();
marks = getMarks();
assert.sameValue(marks[0], 'gray', 'gray key 1');
assert.sameValue(marks[1], 'gray', 'black map, gray key => gray value');
assert.sameValue(marks[2], 'gray', 'gray key 2');
assert.sameValue(marks[3], 'gray', 'black map, gray key => gray value');

// Blacken one of the keys
wrapper1 = grayRoot().root1;
gc();
marks = getMarks();
assert.sameValue(marks[0], 'black', 'black key 1');
assert.sameValue(marks[1], 'black', 'black map, black key => black value');
assert.sameValue(marks[2], 'gray', 'gray key 2');
assert.sameValue(marks[3], 'gray', 'black map, gray key => gray value');
...
assert.sameValue(other_map_mark, 'dead', 'nothing points to wm in other compartment');
assert.sameValue(other_key_mark, 'gray', 'delegate should be gray');
assert.sameValue(other_value_mark, 'dead', 'nothing points to value wrapper in other compartment');
assert.sameValue(map_mark, 'black', 'map in var => black');
assert.sameValue(key_mark, 'gray', 'black map, gray delegate => gray key');
assert.sameValue(value_mark, 'gray', 'black map, gray delegate/key => gray value');
...
assert.sameValue(other_map_mark, 'dead', 'nothing points to wm in other compartment');
assert.sameValue(other_key_mark, 'black', 'delegate held in global.delegate');
assert.sameValue(other_value_mark, 'dead', 'nothing points to value wrapper in other compartment');
assert.sameValue(map_mark, 'black', 'map in var => black');
assert.sameValue(key_mark, 'black', 'black map, black delegate => black key');
assert.sameValue(value_mark, 'black', 'black map, black key => black value');
...
assert.sameValue(other_key_mark, 'black', 'delegate held in global.delegate');
assert.sameValue(other_value_mark, 'dead', 'nothing points to value wrapper in other compartment');
assert.sameValue(map_mark, 'gray', 'map is a gray root');
assert.sameValue(key_mark, 'black', 'black delegate marks its key black');
assert.sameValue(value_mark, 'gray', 'gray map, black key => gray value');
